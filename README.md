...
* Gemini and Claude model represent the default free model of the chatbot (the likeliest model to use), for ChatGPT this was fairly confusing to determine so there might not be parity there.
